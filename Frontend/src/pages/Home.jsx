...
const handleDiagnosis = (result) => {
  ...
  setMessages(prev => [...prev, {
    id: Date.now(),
    text: `Asante kwa picha! Nitumia AI ya hali ya juu...`,
    isBot: true,
    time: "Sasa hivi",
    loading: true
  }])
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-lime-50 to-emerald-50">
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-full max-w-4xl px-6">
        <div className="glass p-4 rounded-full shadow-2xl border border-white/50 flex items-center gap-4">
          <PhotoUploader onDiagnosis={handleDiagnosis} />
          <VoiceRecorder onTranscription={() => {}} />
          <input
            type="text"
            placeholder="Andika au zungumza na JinsiAI..."
            className="flex-1 bg-transparent text-gray-800 placeholder-gray-500 focus:outline-none text-lg"
          />
          <button className="bg-gradient-to-r from-green-500 to-emerald-600 text-white p-5 rounded-full shadow-xl hover:shadow-2xl transform hover:scale-110 transition-all">
